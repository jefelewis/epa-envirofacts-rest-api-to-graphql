...
const RESOLVERS = {
  ...
  //   // Get TOXIC RELEASE INVENTORY (TRI) Facility Company Contacts by State
  //   getToxicReleaseInventoryFacilityContactsByState: (parent, args) => {
  //     return axios.get(`https://iaspub.epa.gov/enviro/efservice/tri_facility/CONTACT/STATE/${args.stateAbbreviation}`)
  //     .then((response) => response.data)
  //     .catch((error) => console.log(error))
  //   },
  ...
  //   // Get TOXIC RELEASE INVENTORY (TRI) Facility Company Contacts by State
  //   getToxicReleaseInventoryFacilityContactsByState: (parent, args) => {
  //     return axios.get(`https://iaspub.epa.gov/enviro/efservice/PWS/CONTACTSTATE/${state.stateAbbreviation}`)
  //     .then((response) => response.data)
  //     .catch((error) => console.log(error))
  //   },
  ...
  //   // https://iaspub.epa.gov/enviro/efservice/t_design_for_environment/
  ...
  // http://iaspub.epa.gov/enviro/efservice/PUB_DIM_FACILITY/STATE/RI/ROWS/0:10/JSON/
  // http://iaspub.epa.gov/enviro/efservice/PUB_DIM_SECTOR/STATE/RI/ROWS/0:10/EXCEL
  // http://iaspub.epa.gov/enviro/efservice/PUB_DIM_SUBSECTOR//STATE/RI/ROWS/0:10/EXCEL  
  // http://iaspub.epa.gov/enviro/efservice/PUB_FACTS_SECTOR_GHG_EMISSION/STATE/RI/ROWS/0:10/EXCEL
  // http://iaspub.epa.gov/enviro/efservice/PUB_FACTS_SUBP_GHG_EMISSION/ROWS/0:10/EXCEL


  // http://iaspub.epa.gov/enviro/efservice/TRI_WATER_STREAM/ROWS/0:10/EXCEL
  // http://iaspub.epa.gov/enviro/efservice/TRI_RELEASE_QTY/ROWS/0:10/EXCEL 
  // http://iaspub.epa.gov/enviro/efservice/TRI_CHEM_INFO/ROWS/0:10/EXCEL


  // http://iaspub.epa.gov/enviro/efservice/VIOLATION/ROWS/0:10/EXCEL 
